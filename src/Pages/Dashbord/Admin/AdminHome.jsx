...
const AdminHome = () => {
  ...
  Z`;
   ...
   //Chart-2
   const color2 = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042'];
   ...
   return (
      <div className="w-full m-4">
         ...
         {/* {chartData.map(entry => <p key={entry._id}>{entry._id}</p>)} */}
            ...
            <div className="w-1/2">
               <ResponsiveContainer width="100%" height="100%">
                  <PieChart width={400} height={400}>
                     ...
                     >
                        {chartData.map((entry, index) => (
                           <Cell name={entry._id} key={`cell-${index}`} fill={color2[index % color2.length]} />
                        ))}
                     </Pie>
                  </PieChart>
               </ResponsiveContainer>
